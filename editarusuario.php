...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-users" aria-hidden="true"></i> Usuários do Sistema</a></li>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box">
            ...
            <form role="form" action="atualizausuario.php" method="post">
              <div class="box-body">
                <div class="col-md-8">
                  ...
                  <div class="form-group">
                    ...
                    <select name="nivel" class="form-control">
                      ...
                      <option value="Administrador" <?php if ($usuario['nivel']== 'Administrador') print 'selected'; ?>>Administrador</option>
                    </select>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <a class="btn btn-success col-md-3" href="editarfoto.php?id=<?php print $usuario['idusuario']; ?>"><i class="fa fa-picture-o" aria-hidden="true"></i> Editar Foto</a>
                  </div>
                </div>
              </div>
              <br>
              ...
              <div class="box-footer">
                <a href="usuario.php" class="btn btn-danger col-md-offset-1 col-md-2"><i class="fa fa-ban" aria-hidden="true"></i> Cancelar</a>
